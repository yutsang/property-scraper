...
from property_scraper.pipelines.midland_ici.nodes import midland_ici_join


def test_midland_ici_join_applies_supplemental_master_and_tracks_match_method(
    tmp_path: Path,
) -> None:
    ...
    with pd.ExcelWriter(master_path, engine="openpyxl") as writer:
        ...
        ).to_excel(writer, sheet_name="midland_ici", index=False)
